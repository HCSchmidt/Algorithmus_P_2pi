...
def main():
    ...
    for j in range (1,29):      
        ...
        if Op in [1] : plt.plot([x_a,x_m],[i4,i4],'k',linewidth=1); plt.text(x_a,i4+15,r'$(2\pi)^4$', fontsize=12, color='blue')
        if Op in [5] : plt.plot([x_a,x_m],[i7,i7],'k',linewidth=1); plt.text(x_a,i7+15, r'$5/2(2\pi)^4-3/2(2\pi)^3-1/2(2\pi)^2$', fontsize=12, color='blue')
        if Op in [5] : plt.plot([x_a,2*x_m],[i8,i8],'k',linewidth=1); plt.text(x_a,i8+15,r'$3/2(2\pi)^4+(2\pi)^3+(2\pi)^2=', fontsize=12, color='blue')
        #if Op in [5] : plt.plot([x_a,3*x_m],[i9,i9],'k',linewidth=1); plt.text(x_a,i9+15,'$2(2\pi)^4+2(2\pi)^3+2(2\pi)^2$', fontsize=12, color='blue')
        if Op in [5] : plt.plot([x_a,3*x_m],[i10,i10],'k',linewidth=1); plt.text(x_a,i10+15,r'$3/2(2\pi)^4+1/2(2\pi)^3-1/2(2\pi)^2$', fontsize=12, color='blue')
        if Op in [1,2] :plt.plot([x_a,x_m],[i3,i3],'k',linewidth=1); plt.text(x_a,i3+15,r'$(2\pi)^3$', fontsize=12, color='blue')
        if Op in [1,2,3]: plt.plot([x_a,x_m],[i2,i2],'k',linewidth=1); plt.text(x_a,i2+15,r'$(2\pi)^2$', fontsize=12, color='blue')
        if Op in [1]: plt.plot([x_a,x_m],[i5,i5],'k',linewidth=1); plt.text(x_a,i5+15,r'$1/2((2\pi)^4+(2\pi)^3+(2\pi)^2)$', fontsize=12,color='blue')
        if Op in [1]: plt.plot([x_a,x_m],[i6,i6],'k',linewidth=1); plt.text(x_a,i6+15,r'$(2\pi)^4+(2\pi)^3+(2\pi)^2$', fontsize=12,color='blue')
