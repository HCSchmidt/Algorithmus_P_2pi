...
def default_particles() -> Dict[str, Particle]:
    ...
    particles = [
        ...
        Particle("proton", "Proton", "p", 1836.152673426, -0.000000032, 0.000000032, "1836.152673426(32)"),
        Particle("h_atom", "H", "H", 1837.47, -0.29, 0.20, "1837.47(-0.29)(0.20)"),
        Particle("neutron", "Neutron", "n", 1838.68366200, -0.00000074, 0.00000074, "1838.68366200(74)"),
